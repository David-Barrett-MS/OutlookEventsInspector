...
namespace InspectorEvents {
    internal class MailItemInspectorWrapper : InspectorWrapper {
        public MailItemInspectorWrapper(Outlook.Inspector inspector)
            : base(inspector) {
        }
        ...
        protected override void Close() {
            Globals.ThisAddIn.EventTrackerForm.AddLog("Inspector_Close (MailItem)");
            Item = null;
            GC.Collect();
